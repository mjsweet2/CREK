...
public class TrikeAndChairApp : MonoBehaviour
{
    ...
    public Machine2ZXYEShell machine2ZXYEShell;
    public Machine2ZXYE machine2ZXYE;
    public Articulated2ZXYE articulated2ZXYE;

    public MachineBalDiffShell machineBalDiffShell;
    ...
    public enum INPUTMODE { TRIKE, BALDIFF };
    ...
    {
        if (inputMode == INPUTMODE.TRIKE)
        {
            machine2ZXYE.rsPoseController.connectUDPClient();
        }
        else
        {   
            //not implemented for BalDiff?
            ;
        }
    }
    public void runCmd()
    {
        if (inputMode == INPUTMODE.TRIKE)
        {
            machine2ZXYEShell.runCmd(inputIF.text);
            inputIF.text = "";
        }
        else
        {
            machineBalDiffShell.runCmd(inputIF.text);
            inputIF.text = "";
        }
