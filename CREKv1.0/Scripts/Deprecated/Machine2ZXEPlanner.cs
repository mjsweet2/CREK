...
public class Machine2ZXEPlanner : MonoBehaviour
{
    ...
    {
        currCrouchlf = machine2ZXE.getlfStance();
        currCrouchrf = machine2ZXE.getrfStance();
    }
    ...
    Vector3 getStanceLF() { return machine2ZXE.getlfStance(); }
    Vector3 getStanceLR() { return machine2ZXE.getlrStance(); }
    Vector3 getStanceRF() { return machine2ZXE.getrfStance(); }
    Vector3 getStanceRR() { return machine2ZXE.getrrStance(); }
    ...
    void createCircleTrajectories()
    {
        ...
        trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXE.lfToMachine(Crouch01lf)));
        for (int i = 0; i < theCircle.Length; i++)
        {
            trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXE.lfToMachine(Crouch01lf + theCircle[i])));
        }
        trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXE.lfToMachine(Crouch01lf)));
        ...
        trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXE.rfToMachine(Crouch01rf)));
        for (int i = 0; i < theCircle.Length; i++)
        {
            trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXE.rfToMachine(Crouch01rf + theCircle[i])));
        }
        trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXE.rfToMachine(Crouch01rf)));
    ...
    void createCrouchTrajectories()
    {
        ...
        // Crouch01
        {
            ...
            trajJSONlf.keyframes.Add(new KeyFrameJSON("raw", machine2ZXE.dormantLFIk()));
            trajJSONlf.keyframes.Add(new KeyFrameJSON("raw", Crouch01lf));

            trajJSONrf.keyframes.Add(new KeyFrameJSON("raw", machine2ZXE.dormantRFIk()));
            trajJSONrf.keyframes.Add(new KeyFrameJSON("raw", Crouch01rf));
