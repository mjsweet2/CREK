...
public class Machine2ZXE : MonoBehaviour
{

    public Articulated2ZXE phys;
    ...
    public Machine2ZXEMotion lfMotion;
    public Machine2ZXEMotion rfMotion;
    public Machine2ZXEMotion segsMotion;
    ...
    {
        lfMotion.setInterupt(Machine2ZXEMotion.MOTIONINTERUPT.SOFTCANCEL);   
        rfMotion.setInterupt(Machine2ZXEMotion.MOTIONINTERUPT.SOFTCANCEL);
        segsMotion.setInterupt(Machine2ZXEMotion.MOTIONINTERUPT.SOFTCANCEL);
    }
