...
public class ArticulatedZXYESegsDemiQuad : MonoBehaviour
{

    public ArticulatedZXYE leftFront;
    public ArticulatedZXYE rightFront;
    public ArticulatedZX leftRear;
    public ArticulatedZX rightRear;


    public ArticulatedSegs segs;

    public CountedSwitch lfSwitch;
    public CountedSwitch rfSwitch;
    ...
    void Update()
    {
        orientation = transformSensor.rotation.eulerAngles;
        buildSensorString();
    ...
    public void buildSensorString()
    {
        ...
        sensorString = lfSwitch.value.ToString() + ";" + rfSwitch.value.ToString();

        sensorString = sensorString + ";" + transformSensor.position.x.ToString("f4");
        sensorString = sensorString + ";" + transformSensor.position.y.ToString("f4");
        sensorString = sensorString + ";" + transformSensor.position.z.ToString("f4");
