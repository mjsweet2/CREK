...
public class Machine2ZXYE2ZXPlanner : MonoBehaviour
{


    public Machine2ZXYE2ZX machine2ZXYE2ZX;
    ...
    public void buildTables()
    {
        ...
        Crouch01lf = new Vector3(-.20f, -.36f, .15f);
        Crouch01rf = new Vector3(.20f, -.36f, .15f);
    ...
    {
        currCrouchlf = machine2ZXYE2ZX.getlfStance();
        currCrouchrf = machine2ZXYE2ZX.getrfStance();
    }
    ...
    Vector3 getStanceLF() { return machine2ZXYE2ZX.getlfStance(); }
    Vector3 getStanceLR() { return machine2ZXYE2ZX.getlrStance(); }
    Vector3 getStanceRF() { return machine2ZXYE2ZX.getrfStance(); }
    Vector3 getStanceRR() { return machine2ZXYE2ZX.getrrStance(); }

    Vector3 getLowerLF() { return machine2ZXYE2ZX.getlfLower(); }
    Vector3 getUpperLF() { return machine2ZXYE2ZX.getlfUpper(); }
    Vector3 getLowerRF() { return machine2ZXYE2ZX.getrfLower(); }
    Vector3 getUpperRF() { return machine2ZXYE2ZX.getrfUpper(); }
    ...
    void createCircleTrajectories()
    {
        ...
        trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXYE2ZX.lfToMachine(Crouch01lf)));
        for (int i = 0; i < theCircle.Length; i++)
        {
            trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXYE2ZX.lfToMachine(Crouch01lf + theCircle[i])));
        }
        trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXYE2ZX.lfToMachine(Crouch01lf)));
        ...
        trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXYE2ZX.rfToMachine(Crouch01rf)));
        for (int i = 0; i < theCircle.Length; i++)
        {
            trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXYE2ZX.rfToMachine(Crouch01rf + theCircle[i])));
        }
        trajJSON.keyframes.Add(new KeyFrameJSON("raw", machine2ZXYE2ZX.rfToMachine(Crouch01rf)));
    ...
    void createCrouchTrajectories()
    {
        ...
        // Crouch01
        {
            ...
            trajJSONlf.keyframes.Add(new KeyFrameJSON("raw", machine2ZXYE2ZX.dormantLFFk()));
            trajJSONlf.keyframes.Add(new KeyFrameJSON("raw", Crouch01lf));

            trajJSONrf.keyframes.Add(new KeyFrameJSON("raw", machine2ZXYE2ZX.dormantRFFk()));
            trajJSONrf.keyframes.Add(new KeyFrameJSON("raw", Crouch01rf));
