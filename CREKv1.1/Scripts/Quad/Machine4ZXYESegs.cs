...
public class Machine4ZXYESegs : MonoBehaviour
{

    public ArticulatedZXYESegsQuad phys;
    ...
    public void loadParams()
    {
        ...
        segs.loadParams(boneLengths["l1"], topBlock, 0f, 0f);
    ...
    void processPoseInput()
    {
        ...
        {
            poseSegs = msPoseController.subject;
        }
        else
        {
    ...
    void poseSegmentsTAndRStance(float sx, float sy, float sz, float tx, float ty, float tz, float rx, float ry, float rz)
    {
        ...
        lrInfluecedPosition = segs.getLowerDeltaPositionInverse(lrPos);
        rrInfluecedPosition = segs.getLowerDeltaPositionInverse(rrPos);

        lrInfluecedRotation = segs.getLowerDeltaRotationInverse(lrRot);
        rrInfluecedRotation = segs.getLowerDeltaRotationInverse(rrRot);
    ...
    void poseSegmentsWithInfluenceTake1(float x, float y, float z)
    {
        ...
        lrInfluecedPosition = segs.getLowerDeltaPositionInverse(lrStance);
        rrInfluecedPosition = segs.getLowerDeltaPositionInverse(rrStance);
